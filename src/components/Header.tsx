      ...
      <div className="bg-[#1B4F72] text-white py-2 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-sm">
          <div className="flex items-center space-x-4">
            <a href="tel:+919876543210" className="flex items-center space-x-1 hover:text-blue-200">
              <Phone size={14} />
              <span>+91 98765 43210</span>
            </a>
            <a href="mailto:info@ecwds.com" className="flex items-center space-x-1 hover:text-blue-200">
              <Mail size={14} />
              <span>info@ecwds.com</span>
            </a>
          </div>
          <div className="flex items-center space-x-2">
            <a href="https://facebook.com/ecwds" className="hover:text-blue-200">
              <Facebook size={16} />
            </a>
            <a href="https://wa.me/919876543210" className="hover:text-blue-200">
