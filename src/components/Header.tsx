        ...
        <div className="bg-[#1B4F72] text-white py-2 px-4">
          <div className="max-w-7xl mx-auto flex justify-between items-center text-sm">
            <div className="flex items-center space-x-4">
              <a href="tel:+919978826343" className="flex items-center space-x-1 hover:text-blue-200 transition-colors">
                <Phone size={14} />
            ...
            <div className="flex items-center space-x-2">
              ...
              <a href="https://wa.me/919978826343" className="hover:text-blue-200 transition-colors">
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/" className="flex items-center space-x-3 hover-scale">
              <img src="/lovable-uploads/edf0bc7a-2f45-4bc2-a2ed-2edb8546c638.png" alt="ECWDS Logo" className="h-14 w-14" />
              <div>
                <h1 className="text-xl font-bold text-[#2E86AB]">ECWDS</h1>
                <p className="text-gray-600 font-semibold text-sm">Enjoy Computer With Divyakant Sir</p>
              </div>
            </Link>
