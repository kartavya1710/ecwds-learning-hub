            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex gap-2">
                  <Button 
                    variant="outline" 
                    className="border-white hover:bg-white px-8 py-4 text-lg font-semibold text-gray-700 animate-[slideInUp_1.4s_ease-out]"
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8">
                {stats.map((stat, index) => <div key={index} className="text-center hover-scale animate-[fadeInUp_1s_ease-out]" style={{animationDelay: `${index * 0.2}s`}}>
                ...
                <img 
                  ...
                  onClick={() => {
                    ...
                    const event = new CustomEvent('openLightbox', { 
                      detail: { images: lightboxImages, index: 0 } 
                    });
